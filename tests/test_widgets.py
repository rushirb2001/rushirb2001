...
URLS = [
    ...
    "/api/hero?name=Ada%20Lovelace&eyebrow=Engineer&tags=RAG|Physics-informed%20ML|Pipelines",
    "/api/hero?name=Ada%20Lovelace&line=Builds%20things",
    "/api/repo?username=u&repo=cohors&size=wide&install=brew%20install%20cohors",
